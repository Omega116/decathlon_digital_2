...
"[project]/components/assistant/MediaPipeAssistant.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ALL_EXERCISES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exerciseData"];
const IDEAL_ANGLES = {
    squat: {
        "Left Knee": [
            80,
...
function MediaPipeAssistant() {
    ...
    const [currentExercise, setCurrentExercise] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(ALL_EXERCISES[0]?.id ?? "");
    ...
    const [feedbackText, setFeedbackText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Click "Start Camera" and begin your exercise to receive real-time AI feedback on your form.');
    const [status, setStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        label: "Ready to analyze",
        variant: "hidden"
    });
    const prevFeedbackRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("");
    const analyzingFlagRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const selectedExercise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MediaPipeAssistant.useMemo[selectedExercise]": ()=>ALL_EXERCISES.find({
                "MediaPipeAssistant.useMemo[selectedExercise]": (e)=>e.id === currentExercise
            }["MediaPipeAssistant.useMemo[selectedExercise]"])
    }["MediaPipeAssistant.useMemo[selectedExercise]"], [
        currentExercise
    ]);
    ...
    const loadScripts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[loadScripts]": async ()=>{
            const add = {
                "MediaPipeAssistant.useCallback[loadScripts].add": (src)=>new Promise({
                        "MediaPipeAssistant.useCallback[loadScripts].add": (resolve, reject)=>{
                            const s = document.createElement("script");
                            s.src = src;
                            s.async = true;
                            s.onload = ({
                                "MediaPipeAssistant.useCallback[loadScripts].add": ()=>resolve()
                            })["MediaPipeAssistant.useCallback[loadScripts].add"];
                            s.onerror = ({
                                "MediaPipeAssistant.useCallback[loadScripts].add": (e)=>reject(e)
                            })["MediaPipeAssistant.useCallback[loadScripts].add"];
    ...
    }["MediaPipeAssistant.useCallback[loadScripts]"], []);
    const updateFeedback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[updateFeedback]": (text)=>{
            setFeedbackText(text);
        }
    }["MediaPipeAssistant.useCallback[updateFeedback]"], []);
    const updateFormStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[updateFormStatus]": (label, kind)=>{
            setStatus({
                label,
                variant: kind
            });
        }
    }["MediaPipeAssistant.useCallback[updateFormStatus]"], []);
    const showAnalyzing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[showAnalyzing]": (show)=>{
            setIsAnalyzing(show);
        }
    }["MediaPipeAssistant.useCallback[showAnalyzing]"], []);
    ...
    const startCamera = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[startCamera]": async ()=>{
            try {
                setLoading(true);
                await loadScripts();
                // Request camera
                ...
                poseRef.current = new window.Pose({
                    locateFile: {
                        "MediaPipeAssistant.useCallback[startCamera]": (file)=>`https://cdn.jsdelivr.net/npm/@mediapipe/pose@0.5.1675469404/${file}`
                    }["MediaPipeAssistant.useCallback[startCamera]"]
                });
    ...
    const stopCamera = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaPipeAssistant.useCallback[stopCamera]": ()=>{
            try {
                const v = videoRef.current;
                const src = v?.srcObject;
                src?.getTracks().forEach({
                    "MediaPipeAssistant.useCallback[stopCamera]": (t)=>t.stop()
                }["MediaPipeAssistant.useCallback[stopCamera]"]);
            ...
            return ({
                "MediaPipeAssistant.useEffect": ()=>{
                    try {
                        ...
                        const src = v?.srcObject;
                        src?.getTracks().forEach({
                            "MediaPipeAssistant.useEffect": (t)=>t.stop()
                        }["MediaPipeAssistant.useEffect"]);
                    } catch  {}
                    try {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: ALL_EXERCISES.map((ex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: ex.id,
                                        children: ex.name
                                    }, ex.id, false, {
                                        fileName: "[project]/components/assistant/MediaPipeAssistant.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    referenceImage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                        src: referenceImage,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    status.variant !== "hidden" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MediaPipeAssistant, "0WLFGo0k7fp0JXqD2JXMYW3nMAw=");
_c = MediaPipeAssistant;
var _c;
__turbopack_context__.k.register(_c, "MediaPipeAssistant");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/badge.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$assistant$2f$MediaPipeAssistant$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/assistant/MediaPipeAssistant.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AssistantPage() {
    _s();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$assistant$2f$MediaPipeAssistant$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=_d92b1b62._.js.map